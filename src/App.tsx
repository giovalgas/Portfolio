        ...
        <div className="App">
            ...
            <div className="content">
                    ...
                    <div className="menu-holder">
                        <div className="name-section">
                            ...
                            <div className="icon-holder">
                                <a className="socials-logo-anchor" href="https://github.com/giovalgas" rel="noreferrer" target="_blank">    
                                ...
                                <a className="socials-logo-anchor" href="https://twitter.com/giovalgas" rel="noreferrer" target="_blank"> 
                                ...
                                <a className="socials-logo-anchor" href="https://discord.gg/qQeFUKsS" rel="noreferrer" target="_blank"> 
                ...
                <section className="services section-content" id="services"> 
                    ...
                    <h2 className="contact-me-footer">Interested in any of these?  
